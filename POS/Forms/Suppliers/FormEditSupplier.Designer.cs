namespace POS.Forms.Suppliers
{
	partial class FormEditSupplier
	{
		...
		private void InitializeComponent()
		{
			...
			this.iconButton1.Location = new System.Drawing.Point(362, 292);
			...
			this.btnUpdate.Location = new System.Drawing.Point(241, 292);
			...
			this.panelDetails.Controls.Add(this.cbxProvince);
			this.panelDetails.Controls.Add(this.label1);
			this.panelDetails.Controls.Add(this.label6);
			this.panelDetails.Controls.Add(this.cbxCity);
			this.panelDetails.Controls.Add(this.tbAirtel);
			...
			this.panelDetails.Controls.Add(this.tbContact2);
			this.panelDetails.Controls.Add(this.tbContact1);
			...
			this.panelDetails.Controls.Add(this.label21);
			...
			this.cbxProvince.Location = new System.Drawing.Point(113, 108);
			...
			this.cbxCity.Location = new System.Drawing.Point(112, 76);
			...
			this.label18.Location = new System.Drawing.Point(490, 115);
			...
			this.label12.Location = new System.Drawing.Point(490, 82);
			...
			this.label10.Location = new System.Drawing.Point(490, 49);
			...
			this.label8.Location = new System.Drawing.Point(100, 178);
			...
			this.btnClear.Location = new System.Drawing.Point(483, 292);
